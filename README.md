...
| :--------------------: | :------------: | :-----: |
| org.fxmisc.wellbehaved | wellbehavedfx  | 0.3.1     |
...
```scala
libraryDependencies += "org.fxmisc.wellbehaved" % "wellbehavedfx" % "0.3.1"
```

### Manual download

[Download](https://oss.sonatype.org/content/groups/public/org/fxmisc/wellbehaved/wellbehavedfx/0.3.1/) the JAR file and place it on your classpath.
...
API documentation: [Javadoc](http://fxmisc.github.io/wellbehaved/javadoc/0.3.1/overview-summary.html)
